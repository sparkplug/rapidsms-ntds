...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NTDReport.parish'
        db.alter_column('ntds_ntdreport', 'parish_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'NTDReport.parish'
        raise RuntimeError("Cannot reverse this migration. 'NTDReport.parish' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'NTDReport.parish'
        db.alter_column('ntds_ntdreport', 'parish_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location']))
    ...
    models = {
        ...
        'ntds.ntdreport': {
            ...
            'parish': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['locations.Location']", 'null': 'True'}),
