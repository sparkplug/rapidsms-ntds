...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ntds_community', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('ntds', ['Community'])

        # Adding M2M table for field communities on 'Reporter'
        m2m_table_name = db.shorten_name('ntds_reporter_communities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('reporter', models.ForeignKey(orm['ntds.reporter'], null=False)),
            ('community', models.ForeignKey(orm['ntds.community'], null=False))
        ))
        db.create_unique(m2m_table_name, ['reporter_id', 'community_id'])


    def backwards(self, orm):
        # Deleting model 'Community'
        db.delete_table('ntds_community')

        # Removing M2M table for field communities on 'Reporter'
        db.delete_table(db.shorten_name('ntds_reporter_communities'))
