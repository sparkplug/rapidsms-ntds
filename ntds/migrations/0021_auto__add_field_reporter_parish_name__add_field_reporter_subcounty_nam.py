...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reporter.subcounty_name'
        db.add_column('ntds_reporter', 'subcounty_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reporter.parish_name'
        db.delete_column('ntds_reporter', 'parish_name')
