...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportProgress.report'
        db.add_column('ntds_reportprogress', 'report',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['ntds.NTDReport']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportProgress.report'
        db.delete_column('ntds_reportprogress', 'report_id')
