...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Reporter.region'
        db.delete_column('ntds_reporter', 'region')

        # Deleting field 'Reporter.subcounty_supervisor'
        db.delete_column('ntds_reporter', 'subcounty_supervisor')

        # Deleting field 'Reporter.subcounty_supervisor_mobile'
        db.delete_column('ntds_reporter', 'subcounty_supervisor_mobile')

        # Deleting field 'Reporter.community'
        db.delete_column('ntds_reporter', 'community')

        # Deleting field 'Reporter.health_subcounty'
        db.delete_column('ntds_reporter', 'health_subcounty')

        # Deleting field 'Reporter.id_number'
        db.delete_column('ntds_reporter', 'id_number')
    ...
    models = {
        ...
        'ntds.reporter': {
            ...
            'community': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'health_subcounty': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            ...
            'id_number': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            ...
            'subcounty_supervisor': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'subcounty_supervisor_mobile': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'ntds.reportprogress': {
