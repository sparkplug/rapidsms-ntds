...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NTDReport.parish'
        db.add_column('ntds_ntdreport', 'parish',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ntds.NtdLocation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NTDReport.parish'
        db.delete_column('ntds_ntdreport', 'parish_id')
