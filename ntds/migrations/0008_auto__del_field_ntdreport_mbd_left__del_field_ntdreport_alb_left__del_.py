...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NTDReport.mbd_left'
        db.delete_column('ntds_ntdreport', 'mbd_left')

        # Deleting field 'NTDReport.alb_left'
        db.delete_column('ntds_ntdreport', 'alb_left')

        # Deleting field 'NTDReport.zitht_left'
        db.delete_column('ntds_ntdreport', 'zitht_left')

        # Deleting field 'NTDReport.ttr_left'
        db.delete_column('ntds_ntdreport', 'ttr_left')

        # Deleting field 'NTDReport.pzq_left'
        db.delete_column('ntds_ntdreport', 'pzq_left')

        # Deleting field 'NTDReport.ivm_left'
        db.delete_column('ntds_ntdreport', 'ivm_left')

        # Deleting field 'NTDReport.ziths_left'
        db.delete_column('ntds_ntdreport', 'ziths_left')

        # Adding field 'NTDReport.treated_4_to_14_male_onch'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_male_onch',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_4_to_14_female_onch'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_female_onch',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_male_onch'
        db.add_column('ntds_ntdreport', 'treated_gt_14_male_onch',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_female_onch'
        db.add_column('ntds_ntdreport', 'treated_gt_14_female_onch',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_4_to_14_male_onch'
        db.add_column('ntds_ntdreport', 'pop_4_to_14_male_onch',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_4_to_14_female_onch'
        db.add_column('ntds_ntdreport', 'pop_4_to_14_female_onch',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_male_onch'
        db.add_column('ntds_ntdreport', 'pop_gt_14_male_onch',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_female_onch'
        db.add_column('ntds_ntdreport', 'pop_gt_14_female_onch',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_4_to_14_male_schi'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_male_schi',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_4_to_14_female_schi'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_female_schi',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_male_schi'
        db.add_column('ntds_ntdreport', 'treated_gt_14_male_schi',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_female_schi'
        db.add_column('ntds_ntdreport', 'treated_gt_14_female_schi',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_4_to_14_male_schi'
        db.add_column('ntds_ntdreport', 'pop_4_to_14_male_schi',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_4_to_14_female_schi'
        db.add_column('ntds_ntdreport', 'pop_4_to_14_female_schi',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_male_schi'
        db.add_column('ntds_ntdreport', 'pop_gt_14_male_schi',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_female_schi'
        db.add_column('ntds_ntdreport', 'pop_gt_14_female_schi',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_4_to_14_male_lyf'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_male_lyf',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_4_to_14_female_lyf'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_female_lyf',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_male_lyf'
        db.add_column('ntds_ntdreport', 'treated_gt_14_male_lyf',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_female_lyf'
        db.add_column('ntds_ntdreport', 'treated_gt_14_female_lyf',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_4_to_14_male_lyf'
        db.add_column('ntds_ntdreport', 'pop_4_to_14_male_lyf',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_4_to_14_female_lyf'
        db.add_column('ntds_ntdreport', 'pop_4_to_14_female_lyf',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_male_lyf'
        db.add_column('ntds_ntdreport', 'pop_gt_14_male_lyf',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_female_lyf'
        db.add_column('ntds_ntdreport', 'pop_gt_14_female_lyf',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_4_to_14_male_fil'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_male_fil',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_4_to_14_female_fil'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_female_fil',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_male_fil'
        db.add_column('ntds_ntdreport', 'treated_gt_14_male_fil',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_female_fil'
        db.add_column('ntds_ntdreport', 'treated_gt_14_female_fil',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_4_to_14_male_fil'
        db.add_column('ntds_ntdreport', 'pop_4_to_14_male_fil',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_4_to_14_female_fil'
        db.add_column('ntds_ntdreport', 'pop_4_to_14_female_fil',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_male_fil'
        db.add_column('ntds_ntdreport', 'pop_gt_14_male_fil',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_female_fil'
        db.add_column('ntds_ntdreport', 'pop_gt_14_female_fil',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_lt_6_male_trac'
        db.add_column('ntds_ntdreport', 'treated_lt_6_male_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_lt_6_female_trac'
        db.add_column('ntds_ntdreport', 'treated_lt_6_female_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_6_to_4_male_trac'
        db.add_column('ntds_ntdreport', 'treated_6_to_4_male_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_6_to_4_female_trac'
        db.add_column('ntds_ntdreport', 'treated_6_to_4_female_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_4_to_14_male_trac'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_male_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_4_to_14_female_trac'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_female_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_male_trac'
        db.add_column('ntds_ntdreport', 'treated_gt_14_male_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_female_trac'
        db.add_column('ntds_ntdreport', 'treated_gt_14_female_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_lt_6_male_trac'
        db.add_column('ntds_ntdreport', 'pop_lt_6_male_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_lt_6_female_trac'
        db.add_column('ntds_ntdreport', 'pop_lt_6_female_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_6_to_4_male_trac'
        db.add_column('ntds_ntdreport', 'pop_6_to_4_male_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_6_to_4_female_trac'
        db.add_column('ntds_ntdreport', 'pop_6_to_4_female_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_4_to_14_male_trac'
        db.add_column('ntds_ntdreport', 'pop_4_to_14_male_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_4_to_14_female_trac'
        db.add_column('ntds_ntdreport', 'pop_4_to_14_female_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_male_trac'
        db.add_column('ntds_ntdreport', 'pop_gt_14_male_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_female_trac'
        db.add_column('ntds_ntdreport', 'pop_gt_14_female_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_4_to_14_male_hel'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_male_hel',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_4_to_14_female_hel'
        db.add_column('ntds_ntdreport', 'treated_4_to_14_female_hel',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_male_hel'
        db.add_column('ntds_ntdreport', 'treated_gt_14_male_hel',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.treated_gt_14_female_hel'
        db.add_column('ntds_ntdreport', 'treated_gt_14_female_hel',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_4_to_14_hel'
        db.add_column('ntds_ntdreport', 'pop_4_to_14_hel',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_male_hel'
        db.add_column('ntds_ntdreport', 'pop_gt_14_male_hel',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pop_gt_14_female_hel'
        db.add_column('ntds_ntdreport', 'pop_gt_14_female_hel',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.alb_received'
        db.add_column('ntds_ntdreport', 'alb_received',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ivm_received'
        db.add_column('ntds_ntdreport', 'ivm_received',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pzq_received'
        db.add_column('ntds_ntdreport', 'pzq_received',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.mbd_received'
        db.add_column('ntds_ntdreport', 'mbd_received',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ttr_received'
        db.add_column('ntds_ntdreport', 'ttr_received',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ziths_received'
        db.add_column('ntds_ntdreport', 'ziths_received',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.zitht_received'
        db.add_column('ntds_ntdreport', 'zitht_received',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.alb_wasted'
        db.add_column('ntds_ntdreport', 'alb_wasted',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ivm_wasted'
        db.add_column('ntds_ntdreport', 'ivm_wasted',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pzq_wasted'
        db.add_column('ntds_ntdreport', 'pzq_wasted',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.mbd_wasted'
        db.add_column('ntds_ntdreport', 'mbd_wasted',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ttr_wasted'
        db.add_column('ntds_ntdreport', 'ttr_wasted',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ziths_wasted'
        db.add_column('ntds_ntdreport', 'ziths_wasted',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.zitht_wasted'
        db.add_column('ntds_ntdreport', 'zitht_wasted',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NTDReport.mbd_left'
        db.add_column('ntds_ntdreport', 'mbd_left',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.alb_left'
        db.add_column('ntds_ntdreport', 'alb_left',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.zitht_left'
        db.add_column('ntds_ntdreport', 'zitht_left',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ttr_left'
        db.add_column('ntds_ntdreport', 'ttr_left',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pzq_left'
        db.add_column('ntds_ntdreport', 'pzq_left',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ivm_left'
        db.add_column('ntds_ntdreport', 'ivm_left',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ziths_left'
        db.add_column('ntds_ntdreport', 'ziths_left',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Deleting field 'NTDReport.treated_4_to_14_male_onch'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_male_onch')

        # Deleting field 'NTDReport.treated_4_to_14_female_onch'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_female_onch')

        # Deleting field 'NTDReport.treated_gt_14_male_onch'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_male_onch')

        # Deleting field 'NTDReport.treated_gt_14_female_onch'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_female_onch')

        # Deleting field 'NTDReport.pop_4_to_14_male_onch'
        db.delete_column('ntds_ntdreport', 'pop_4_to_14_male_onch')

        # Deleting field 'NTDReport.pop_4_to_14_female_onch'
        db.delete_column('ntds_ntdreport', 'pop_4_to_14_female_onch')

        # Deleting field 'NTDReport.pop_gt_14_male_onch'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_male_onch')

        # Deleting field 'NTDReport.pop_gt_14_female_onch'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_female_onch')

        # Deleting field 'NTDReport.treated_4_to_14_male_schi'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_male_schi')

        # Deleting field 'NTDReport.treated_4_to_14_female_schi'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_female_schi')

        # Deleting field 'NTDReport.treated_gt_14_male_schi'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_male_schi')

        # Deleting field 'NTDReport.treated_gt_14_female_schi'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_female_schi')

        # Deleting field 'NTDReport.pop_4_to_14_male_schi'
        db.delete_column('ntds_ntdreport', 'pop_4_to_14_male_schi')

        # Deleting field 'NTDReport.pop_4_to_14_female_schi'
        db.delete_column('ntds_ntdreport', 'pop_4_to_14_female_schi')

        # Deleting field 'NTDReport.pop_gt_14_male_schi'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_male_schi')

        # Deleting field 'NTDReport.pop_gt_14_female_schi'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_female_schi')

        # Deleting field 'NTDReport.treated_4_to_14_male_lyf'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_male_lyf')

        # Deleting field 'NTDReport.treated_4_to_14_female_lyf'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_female_lyf')

        # Deleting field 'NTDReport.treated_gt_14_male_lyf'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_male_lyf')

        # Deleting field 'NTDReport.treated_gt_14_female_lyf'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_female_lyf')

        # Deleting field 'NTDReport.pop_4_to_14_male_lyf'
        db.delete_column('ntds_ntdreport', 'pop_4_to_14_male_lyf')

        # Deleting field 'NTDReport.pop_4_to_14_female_lyf'
        db.delete_column('ntds_ntdreport', 'pop_4_to_14_female_lyf')

        # Deleting field 'NTDReport.pop_gt_14_male_lyf'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_male_lyf')

        # Deleting field 'NTDReport.pop_gt_14_female_lyf'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_female_lyf')

        # Deleting field 'NTDReport.treated_4_to_14_male_fil'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_male_fil')

        # Deleting field 'NTDReport.treated_4_to_14_female_fil'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_female_fil')

        # Deleting field 'NTDReport.treated_gt_14_male_fil'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_male_fil')

        # Deleting field 'NTDReport.treated_gt_14_female_fil'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_female_fil')

        # Deleting field 'NTDReport.pop_4_to_14_male_fil'
        db.delete_column('ntds_ntdreport', 'pop_4_to_14_male_fil')

        # Deleting field 'NTDReport.pop_4_to_14_female_fil'
        db.delete_column('ntds_ntdreport', 'pop_4_to_14_female_fil')

        # Deleting field 'NTDReport.pop_gt_14_male_fil'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_male_fil')

        # Deleting field 'NTDReport.pop_gt_14_female_fil'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_female_fil')

        # Deleting field 'NTDReport.treated_lt_6_male_trac'
        db.delete_column('ntds_ntdreport', 'treated_lt_6_male_trac')

        # Deleting field 'NTDReport.treated_lt_6_female_trac'
        db.delete_column('ntds_ntdreport', 'treated_lt_6_female_trac')

        # Deleting field 'NTDReport.treated_6_to_4_male_trac'
        db.delete_column('ntds_ntdreport', 'treated_6_to_4_male_trac')

        # Deleting field 'NTDReport.treated_6_to_4_female_trac'
        db.delete_column('ntds_ntdreport', 'treated_6_to_4_female_trac')

        # Deleting field 'NTDReport.treated_4_to_14_male_trac'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_male_trac')

        # Deleting field 'NTDReport.treated_4_to_14_female_trac'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_female_trac')

        # Deleting field 'NTDReport.treated_gt_14_male_trac'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_male_trac')

        # Deleting field 'NTDReport.treated_gt_14_female_trac'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_female_trac')

        # Deleting field 'NTDReport.pop_lt_6_male_trac'
        db.delete_column('ntds_ntdreport', 'pop_lt_6_male_trac')

        # Deleting field 'NTDReport.pop_lt_6_female_trac'
        db.delete_column('ntds_ntdreport', 'pop_lt_6_female_trac')

        # Deleting field 'NTDReport.pop_6_to_4_male_trac'
        db.delete_column('ntds_ntdreport', 'pop_6_to_4_male_trac')

        # Deleting field 'NTDReport.pop_6_to_4_female_trac'
        db.delete_column('ntds_ntdreport', 'pop_6_to_4_female_trac')

        # Deleting field 'NTDReport.pop_4_to_14_male_trac'
        db.delete_column('ntds_ntdreport', 'pop_4_to_14_male_trac')

        # Deleting field 'NTDReport.pop_4_to_14_female_trac'
        db.delete_column('ntds_ntdreport', 'pop_4_to_14_female_trac')

        # Deleting field 'NTDReport.pop_gt_14_male_trac'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_male_trac')

        # Deleting field 'NTDReport.pop_gt_14_female_trac'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_female_trac')

        # Deleting field 'NTDReport.treated_4_to_14_male_hel'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_male_hel')

        # Deleting field 'NTDReport.treated_4_to_14_female_hel'
        db.delete_column('ntds_ntdreport', 'treated_4_to_14_female_hel')

        # Deleting field 'NTDReport.treated_gt_14_male_hel'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_male_hel')

        # Deleting field 'NTDReport.treated_gt_14_female_hel'
        db.delete_column('ntds_ntdreport', 'treated_gt_14_female_hel')

        # Deleting field 'NTDReport.pop_4_to_14_hel'
        db.delete_column('ntds_ntdreport', 'pop_4_to_14_hel')

        # Deleting field 'NTDReport.pop_gt_14_male_hel'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_male_hel')

        # Deleting field 'NTDReport.pop_gt_14_female_hel'
        db.delete_column('ntds_ntdreport', 'pop_gt_14_female_hel')

        # Deleting field 'NTDReport.alb_received'
        db.delete_column('ntds_ntdreport', 'alb_received')

        # Deleting field 'NTDReport.ivm_received'
        db.delete_column('ntds_ntdreport', 'ivm_received')

        # Deleting field 'NTDReport.pzq_received'
        db.delete_column('ntds_ntdreport', 'pzq_received')

        # Deleting field 'NTDReport.mbd_received'
        db.delete_column('ntds_ntdreport', 'mbd_received')

        # Deleting field 'NTDReport.ttr_received'
        db.delete_column('ntds_ntdreport', 'ttr_received')

        # Deleting field 'NTDReport.ziths_received'
        db.delete_column('ntds_ntdreport', 'ziths_received')

        # Deleting field 'NTDReport.zitht_received'
        db.delete_column('ntds_ntdreport', 'zitht_received')

        # Deleting field 'NTDReport.alb_wasted'
        db.delete_column('ntds_ntdreport', 'alb_wasted')

        # Deleting field 'NTDReport.ivm_wasted'
        db.delete_column('ntds_ntdreport', 'ivm_wasted')

        # Deleting field 'NTDReport.pzq_wasted'
        db.delete_column('ntds_ntdreport', 'pzq_wasted')

        # Deleting field 'NTDReport.mbd_wasted'
        db.delete_column('ntds_ntdreport', 'mbd_wasted')

        # Deleting field 'NTDReport.ttr_wasted'
        db.delete_column('ntds_ntdreport', 'ttr_wasted')

        # Deleting field 'NTDReport.ziths_wasted'
        db.delete_column('ntds_ntdreport', 'ziths_wasted')

        # Deleting field 'NTDReport.zitht_wasted'
        db.delete_column('ntds_ntdreport', 'zitht_wasted')
    ...
    models = {
        ...
        'ntds.ntdreport': {
            ...
            'pop_4_to_14_hel': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '10', 'blank': 'True'}),
