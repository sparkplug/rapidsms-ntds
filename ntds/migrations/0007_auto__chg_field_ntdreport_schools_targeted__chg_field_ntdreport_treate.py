...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NTDReport.schools_targeted'
        db.alter_column('ntds_ntdreport', 'schools_targeted', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.treated_4_to_14_female'
        db.alter_column('ntds_ntdreport', 'treated_4_to_14_female', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.lymphatic'
        db.alter_column('ntds_ntdreport', 'lymphatic', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.total_schools'
        db.alter_column('ntds_ntdreport', 'total_schools', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.treated_4_to_14_male'
        db.alter_column('ntds_ntdreport', 'treated_4_to_14_male', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.treated_lt_6_female'
        db.alter_column('ntds_ntdreport', 'treated_lt_6_female', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.trachoma'
        db.alter_column('ntds_ntdreport', 'trachoma', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.treated_lt_6_male'
        db.alter_column('ntds_ntdreport', 'treated_lt_6_male', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.pop_lt_6_female'
        db.alter_column('ntds_ntdreport', 'pop_lt_6_female', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.mbd_left'
        db.alter_column('ntds_ntdreport', 'mbd_left', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.pop_lt_6_male'
        db.alter_column('ntds_ntdreport', 'pop_lt_6_male', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.ziths_used'
        db.alter_column('ntds_ntdreport', 'ziths_used', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.alb_left'
        db.alter_column('ntds_ntdreport', 'alb_left', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.villages_targeted'
        db.alter_column('ntds_ntdreport', 'villages_targeted', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.alb_used'
        db.alter_column('ntds_ntdreport', 'alb_used', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.ivm_used'
        db.alter_column('ntds_ntdreport', 'ivm_used', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.schools_incomplete'
        db.alter_column('ntds_ntdreport', 'schools_incomplete', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.treated_6_to_4_female'
        db.alter_column('ntds_ntdreport', 'treated_6_to_4_female', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.pop_4_to_14_male'
        db.alter_column('ntds_ntdreport', 'pop_4_to_14_male', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.pop_gt_14_female'
        db.alter_column('ntds_ntdreport', 'pop_gt_14_female', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.helminthiasis'
        db.alter_column('ntds_ntdreport', 'helminthiasis', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.treated_gt_14_female'
        db.alter_column('ntds_ntdreport', 'treated_gt_14_female', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.zitht_left'
        db.alter_column('ntds_ntdreport', 'zitht_left', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.pop_6_to_4_female'
        db.alter_column('ntds_ntdreport', 'pop_6_to_4_female', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.pzq_used'
        db.alter_column('ntds_ntdreport', 'pzq_used', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.villages_treated'
        db.alter_column('ntds_ntdreport', 'villages_treated', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.pop_6_to_4_male'
        db.alter_column('ntds_ntdreport', 'pop_6_to_4_male', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.schistosomiasis'
        db.alter_column('ntds_ntdreport', 'schistosomiasis', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.population'
        db.alter_column('ntds_ntdreport', 'population', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.pop_gt_14_male'
        db.alter_column('ntds_ntdreport', 'pop_gt_14_male', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.ivm_left'
        db.alter_column('ntds_ntdreport', 'ivm_left', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.ttr_left'
        db.alter_column('ntds_ntdreport', 'ttr_left', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.mbd_used'
        db.alter_column('ntds_ntdreport', 'mbd_used', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.schools_treated'
        db.alter_column('ntds_ntdreport', 'schools_treated', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.ziths_left'
        db.alter_column('ntds_ntdreport', 'ziths_left', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.pop_4_to_14_female'
        db.alter_column('ntds_ntdreport', 'pop_4_to_14_female', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.filariasis'
        db.alter_column('ntds_ntdreport', 'filariasis', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.total_villages'
        db.alter_column('ntds_ntdreport', 'total_villages', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.treated_gt_14_male'
        db.alter_column('ntds_ntdreport', 'treated_gt_14_male', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.pzq_left'
        db.alter_column('ntds_ntdreport', 'pzq_left', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.treated_6_to_4_male'
        db.alter_column('ntds_ntdreport', 'treated_6_to_4_male', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.zitht_used'
        db.alter_column('ntds_ntdreport', 'zitht_used', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.villages_incomplete'
        db.alter_column('ntds_ntdreport', 'villages_incomplete', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.ttr_used'
        db.alter_column('ntds_ntdreport', 'ttr_used', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'NTDReport.onchocerciasis'
        db.alter_column('ntds_ntdreport', 'onchocerciasis', self.gf('django.db.models.fields.IntegerField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'NTDReport.schools_targeted'
        db.alter_column('ntds_ntdreport', 'schools_targeted', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.treated_4_to_14_female'
        db.alter_column('ntds_ntdreport', 'treated_4_to_14_female', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.lymphatic'
        db.alter_column('ntds_ntdreport', 'lymphatic', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.total_schools'
        db.alter_column('ntds_ntdreport', 'total_schools', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.treated_4_to_14_male'
        db.alter_column('ntds_ntdreport', 'treated_4_to_14_male', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.treated_lt_6_female'
        db.alter_column('ntds_ntdreport', 'treated_lt_6_female', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.trachoma'
        db.alter_column('ntds_ntdreport', 'trachoma', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.treated_lt_6_male'
        db.alter_column('ntds_ntdreport', 'treated_lt_6_male', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.pop_lt_6_female'
        db.alter_column('ntds_ntdreport', 'pop_lt_6_female', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.mbd_left'
        db.alter_column('ntds_ntdreport', 'mbd_left', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.pop_lt_6_male'
        db.alter_column('ntds_ntdreport', 'pop_lt_6_male', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.ziths_used'
        db.alter_column('ntds_ntdreport', 'ziths_used', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.alb_left'
        db.alter_column('ntds_ntdreport', 'alb_left', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.villages_targeted'
        db.alter_column('ntds_ntdreport', 'villages_targeted', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.alb_used'
        db.alter_column('ntds_ntdreport', 'alb_used', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.ivm_used'
        db.alter_column('ntds_ntdreport', 'ivm_used', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.schools_incomplete'
        db.alter_column('ntds_ntdreport', 'schools_incomplete', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.treated_6_to_4_female'
        db.alter_column('ntds_ntdreport', 'treated_6_to_4_female', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.pop_4_to_14_male'
        db.alter_column('ntds_ntdreport', 'pop_4_to_14_male', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.pop_gt_14_female'
        db.alter_column('ntds_ntdreport', 'pop_gt_14_female', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.helminthiasis'
        db.alter_column('ntds_ntdreport', 'helminthiasis', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.treated_gt_14_female'
        db.alter_column('ntds_ntdreport', 'treated_gt_14_female', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.zitht_left'
        db.alter_column('ntds_ntdreport', 'zitht_left', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.pop_6_to_4_female'
        db.alter_column('ntds_ntdreport', 'pop_6_to_4_female', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.pzq_used'
        db.alter_column('ntds_ntdreport', 'pzq_used', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.villages_treated'
        db.alter_column('ntds_ntdreport', 'villages_treated', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.pop_6_to_4_male'
        db.alter_column('ntds_ntdreport', 'pop_6_to_4_male', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.schistosomiasis'
        db.alter_column('ntds_ntdreport', 'schistosomiasis', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.population'
        db.alter_column('ntds_ntdreport', 'population', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.pop_gt_14_male'
        db.alter_column('ntds_ntdreport', 'pop_gt_14_male', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.ivm_left'
        db.alter_column('ntds_ntdreport', 'ivm_left', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.ttr_left'
        db.alter_column('ntds_ntdreport', 'ttr_left', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.mbd_used'
        db.alter_column('ntds_ntdreport', 'mbd_used', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.schools_treated'
        db.alter_column('ntds_ntdreport', 'schools_treated', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.ziths_left'
        db.alter_column('ntds_ntdreport', 'ziths_left', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.pop_4_to_14_female'
        db.alter_column('ntds_ntdreport', 'pop_4_to_14_female', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.filariasis'
        db.alter_column('ntds_ntdreport', 'filariasis', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.total_villages'
        db.alter_column('ntds_ntdreport', 'total_villages', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.treated_gt_14_male'
        db.alter_column('ntds_ntdreport', 'treated_gt_14_male', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.pzq_left'
        db.alter_column('ntds_ntdreport', 'pzq_left', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.treated_6_to_4_male'
        db.alter_column('ntds_ntdreport', 'treated_6_to_4_male', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.zitht_used'
        db.alter_column('ntds_ntdreport', 'zitht_used', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.villages_incomplete'
        db.alter_column('ntds_ntdreport', 'villages_incomplete', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.ttr_used'
        db.alter_column('ntds_ntdreport', 'ttr_used', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))

        # Changing field 'NTDReport.onchocerciasis'
        db.alter_column('ntds_ntdreport', 'onchocerciasis', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))
