...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NTDReport.mbd'
        db.delete_column('ntds_ntdreport', 'mbd')

        # Deleting field 'NTDReport.ttr'
        db.delete_column('ntds_ntdreport', 'ttr')

        # Deleting field 'NTDReport.ziths'
        db.delete_column('ntds_ntdreport', 'ziths')

        # Deleting field 'NTDReport.alb'
        db.delete_column('ntds_ntdreport', 'alb')

        # Deleting field 'NTDReport.zitht'
        db.delete_column('ntds_ntdreport', 'zitht')

        # Deleting field 'NTDReport.ivm'
        db.delete_column('ntds_ntdreport', 'ivm')

        # Deleting field 'NTDReport.pzq'
        db.delete_column('ntds_ntdreport', 'pzq')

        # Adding field 'NTDReport.alb_used'
        db.add_column('ntds_ntdreport', 'alb_used',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ivm_used'
        db.add_column('ntds_ntdreport', 'ivm_used',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pzq_used'
        db.add_column('ntds_ntdreport', 'pzq_used',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.mbd_used'
        db.add_column('ntds_ntdreport', 'mbd_used',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ttr_used'
        db.add_column('ntds_ntdreport', 'ttr_used',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ziths_used'
        db.add_column('ntds_ntdreport', 'ziths_used',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.zitht_used'
        db.add_column('ntds_ntdreport', 'zitht_used',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'NTDReport.mbd'
        db.add_column('ntds_ntdreport', 'mbd',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ttr'
        db.add_column('ntds_ntdreport', 'ttr',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ziths'
        db.add_column('ntds_ntdreport', 'ziths',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.alb'
        db.add_column('ntds_ntdreport', 'alb',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.zitht'
        db.add_column('ntds_ntdreport', 'zitht',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.ivm'
        db.add_column('ntds_ntdreport', 'ivm',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.pzq'
        db.add_column('ntds_ntdreport', 'pzq',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'NTDReport.alb_used'
        db.delete_column('ntds_ntdreport', 'alb_used')

        # Deleting field 'NTDReport.ivm_used'
        db.delete_column('ntds_ntdreport', 'ivm_used')

        # Deleting field 'NTDReport.pzq_used'
        db.delete_column('ntds_ntdreport', 'pzq_used')

        # Deleting field 'NTDReport.mbd_used'
        db.delete_column('ntds_ntdreport', 'mbd_used')

        # Deleting field 'NTDReport.ttr_used'
        db.delete_column('ntds_ntdreport', 'ttr_used')

        # Deleting field 'NTDReport.ziths_used'
        db.delete_column('ntds_ntdreport', 'ziths_used')

        # Deleting field 'NTDReport.zitht_used'
        db.delete_column('ntds_ntdreport', 'zitht_used')
    ...
    models = {
        ...
        'ntds.ntdreport': {
            ...
            'alb_left': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'alb_used': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ivm_left': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'ivm_used': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'lymphatic': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'mbd_left': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'mbd_used': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'pzq_left': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'pzq_used': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'ttr_left': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'ttr_used': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'ziths_left': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'ziths_used': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'zitht_left': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'zitht_used': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'})
        },
        'ntds.optinword': {
