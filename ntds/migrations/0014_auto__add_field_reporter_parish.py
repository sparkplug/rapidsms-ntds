...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reporter.parish'
        db.add_column('ntds_reporter', 'parish',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parish', null=True, to=orm['locations.Location']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reporter.parish'
        db.delete_column('ntds_reporter', 'parish_id')
    ...
    models = {
        ...
        'ntds.ntdreport': {
            ...
            'parish': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ntds.NtdLocation']"}),
