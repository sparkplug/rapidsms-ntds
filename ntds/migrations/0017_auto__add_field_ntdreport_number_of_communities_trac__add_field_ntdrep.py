...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NTDReport.number_of_communities_trac'
        db.add_column('ntds_ntdreport', 'number_of_communities_trac',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.number_of_communities_hel'
        db.add_column('ntds_ntdreport', 'number_of_communities_hel',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.number_of_communities_onch'
        db.add_column('ntds_ntdreport', 'number_of_communities_onch',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.number_of_communities_schi'
        db.add_column('ntds_ntdreport', 'number_of_communities_schi',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.number_of_communities_lyf'
        db.add_column('ntds_ntdreport', 'number_of_communities_lyf',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'NTDReport.number_of_communities_fil'
        db.add_column('ntds_ntdreport', 'number_of_communities_fil',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NTDReport.number_of_communities_trac'
        db.delete_column('ntds_ntdreport', 'number_of_communities_trac')

        # Deleting field 'NTDReport.number_of_communities_hel'
        db.delete_column('ntds_ntdreport', 'number_of_communities_hel')

        # Deleting field 'NTDReport.number_of_communities_onch'
        db.delete_column('ntds_ntdreport', 'number_of_communities_onch')

        # Deleting field 'NTDReport.number_of_communities_schi'
        db.delete_column('ntds_ntdreport', 'number_of_communities_schi')

        # Deleting field 'NTDReport.number_of_communities_lyf'
        db.delete_column('ntds_ntdreport', 'number_of_communities_lyf')

        # Deleting field 'NTDReport.number_of_communities_fil'
        db.delete_column('ntds_ntdreport', 'number_of_communities_fil')
